...
export function getAllCategories(tags = []){
	...
	return Array.from( new Set(tags.map( tag => ({
		...
		"4.04 Deutsch als Fremdsprache":		["intercultural", "intercultural_language_course", "german_as_a_foreign_language", "intercultural_de_foreign"],
		"Türkisch":								["intercultural", "intercultural_language_course"],
		"7.05 Deutsch als Femdsprache":			["intercultural", "intercultural_language_course", "german_as_a_foreign_language", "intercultural_de_foreign"],
		...
		"1.16 Verbraucherfragen":				["counseling", "counseling_consumer"],
		"2.01 Literatur/Theater":				["arts", 'arts_theater'],
		"2.02 Theaterarbeit/Sprecherziehung":	["arts", 'arts_theater'],
		"2.03 Kunst/Kulturgeschichte":			["arts", "arts_cultural_art"],
		"2.04 Bildende Kunst":					["arts", "arts_cultural_art"],
		"2.05 Malen/Zeichnen/Drucktechniken":	["arts", "arts_paint_draw_print"],
		"2.06 Plastisches Gestalten":			["arts", "arts_crafts"],
		"2.07 Musik":							["arts", "arts_music"],
		"2.08 Musikalische Praxis":				["arts", "arts_music"],
		"2.09 Tanz":							["exercise", "exercise_dance"],
		"2.10 Medien":							["it", "it_courses"],
		"2.11 Medienpraxis":					["it", "it_courses"],
		"2.12 Werken":							["arts", "arts_crafts"],
		"2.13 Textiles Gestalten":				["arts", "arts_sew"],
		"2.14 Textilkunde/Mode/Nähen":			["arts", "arts_sew"],
		"3.01 Autogenes Training/Yoga etc.":	["exercise", "exercise_motor"],
		"3.02 Gymnastik, Bewegung etc.":		["exercise", "exercise_motor"],
		"3.03 Abhängigkeit/Psychosomatik":		["exercise", "exercise_health"],
		"3.04 Erkrankungen/Heilmethoden":		["exercise", "exercise_health"],
		"3.05 Gesundheits-/Krankenpflege":		["exercise", "exercise_health"],
		"3.06 Gesundheitspolitik/-wesen":		["exercise", "exercise_health"],
		...
		"4.04 Deutsch als Fremdsprache":		["intercultural", "intercultural_language_course", "intercultural_de_foreign"],
		...
		"Philosophie":							["culture", "culture_relegion", "education_philosophy"],
		...
		"Altersvorsorge":						["counseling", "counseling_care"],
		"Geldanlage":							["counseling"],
		"Recht":								["counseling", "counseling_legal"],
		"Verbraucherschutz":					["counseling", "counseling_care", "counseling_consumer"],
		...
		"FOTO":									["arts", "arts_photo_film_media"],
		"FILM":									["arts", "arts_photo_film_media"],
		"MEDIEN":								["arts", "arts_photo_film_media"],
		"Digitale Fotografie":					["arts", "arts_photo_film_media"],
		"Bildbearbeitung":						["arts", "arts_photo_film_media"],
		"Farbfotografie":						["arts", "arts_photo_film_media"],
		"Schwarz-Weiss-Fotografie":				["arts", "arts_photo_film_media"],
		"Filmbesprechungen":					["arts", "arts_photo_film_media"],
		"Video":								["arts", "arts_photo_film_media"],
		"Mediendesign":							["arts", "arts_photo_film_media"],
		"Printmedien":							["arts", "arts_photo_film_media"],
		"Rundfunk":								["arts", "arts_photo_film_media"],
		"Fernsehen":							["arts", "arts_photo_film_media"],
		"Filmgeschichte":						["arts", "arts_photo_film_media"],
		"Filmproduktion":						["arts", "arts_photo_film_media"],
		"Filmschauspiel":						["arts", "arts_photo_film_media"],
		"Thematische Fotografie":				["arts", "arts_photo_film_media"],
		"KUNSTHANDWERK":						["arts", "arts_crafts"],
		"Holzgestaltung":						["arts", "arts_crafts"],
		"Goldschmieden":						["arts", "arts_crafts"],
		"Schmuck":								["arts", "arts_crafts"],
		"Papierkunst":							["arts", "arts_crafts"],
		"Restaurieren":							["arts", "arts_crafts"],
		"Floristik":							["arts", "arts_crafts"],
		"SCHREIBEN":							["arts", "arts_writing"],
		"Autobiografie":						["arts", "arts_writing"],
		"Drehbuch":								["arts", "arts_writing"],
		"Hörspiel":								["arts", "arts_writing"],
		"Journalismus":							["arts", "arts_writing"],
		"Kreatives Schreiben":					["arts", "arts_writing"],
		"Szenisches Schreiben":					["arts", "arts_writing"],
		"Atelier":								["arts", "arts_cultural_art"],
		"Geschichte":							["arts", "arts_cultural_art"],
		"Kunsttheorie":							["arts", "arts_cultural_art"],
		"Museum":								["arts", "arts_cultural_art"],
		...
		"MALEN":								["arts", "arts_paint_draw_print"],
		"ZEICHNEN":								["arts", "arts_paint_draw_print"],
		"Druckgrafik":							["arts", "arts_paint_draw_print"],
		"Figur":								["arts", "arts_paint_draw_print"],
		"Akt":									["arts", "arts_paint_draw_print"],								
		"Portrait":								["arts", "arts_paint_draw_print"],
		"Layout":								["arts", "arts_paint_draw_print"],								
		"Grafikdesign":							["arts", "arts_paint_draw_print"],
		"Maltechniken":							["arts", "arts_paint_draw_print"],
		"Zeichentechniken":						["arts", "arts_paint_draw_print"],
		"Stadt-Land-Natur":						["arts", "arts_paint_draw_print"],
		"Acrylmalerei":							["arts", "arts_paint_draw_print"],
		"Ölmalerei":							["arts", "arts_paint_draw_print"],
		"Aquarellmalerei":						["arts", "arts_paint_draw_print"],
		"Sonstige Maltechniken":				["arts", "arts_paint_draw_print"],
		"Vorbereitung Kunsthochschule":			["arts", "arts_paint_draw_print"],
		"MUSIK":								["arts", "arts_music"],
		"Gesang":								["arts", "arts_choir"],
		"Instrumentalunterricht":				["arts", "arts_music"],
		"Musikgeschichte":						["arts", "arts_music"],
		"Musiktheorie":							["arts", "arts_music"],
		"PLASTISCHES GESTALTEN":				["arts", "arts_crafts"],
		"Bildhauerei":							["arts", "arts_crafts"],
		"Keramik":								["arts", "arts_crafts"],
		"Metallplastik":						["arts", "arts_crafts"],
		"Raku":									["arts", "arts_crafts"],
		"SCHAUSPIEL":							["arts", 'arts_theater'],
		"Bewegungstheater":						["arts", 'arts_theater'],
		"Improvisationstheater":				["arts", 'arts_theater'],
		"Kleinkunst":							["arts", 'arts_theater'],
		"Puppentheater":						["arts", 'arts_theater'],
		"Stimmbildung":							["arts", 'arts_theater'],
		"Sprecherziehung":						["arts", 'arts_theater'],
		"Theatergewerke":						["arts", 'arts_theater'],
		"Vorbereitung Schauspielschule":		["arts", 'arts_theater'],
		"THEATER":								["arts", 'arts_theater'],
		"TANZ":									["arts", "arts_dancetypes"],
		"Afrikanischer Tanz":					["arts", "arts_dancetypes"],
		"Orientalischer Tanz":					["arts", "arts_dancetypes"],
		"Ballett":								["arts", "arts_dancetypes"],
		"Modern Dance":							["arts", "arts_dancetypes"],
		"Folkloretanz":							["arts", "arts_dancetypes"],
		"World Dance":							["arts", "arts_dancetypes"],
		"Gesellschaftstanz":					["arts", "arts_dancetypes"],
		"Historischer Tanz":					["arts", "arts_dancetypes"],
		"Jazz Dance":							["arts", "arts_dancetypes"],
		"Hip Hop":								["arts", "arts_dancetypes"],
		"Lateinamerikanischer Tanz":			["arts", "arts_dancetypes"],
		"Stepptanz":							["arts", "arts_dancetypes"],
		"Flamenco":								["arts", "arts_dancetypes"],
		"Tanzimprovisation":					["arts", "arts_dancetypes"],
		"Tanztheater":							["arts", "arts_dancetypes"],
		"Tango":								["arts", "arts_dancetypes"],
		"Salsa":								["arts", "arts_dancetypes"],
		"Mode":									["arts", "arts_sew"],
		"Nähen":								["arts", "arts_sew"],
		"Schneidern":							["arts", "arts_sew"],
		"TEXTILGESTALTUNG":						["arts", "arts_sew"],
		"Schnittkonstruktion":					["arts", "arts_sew"],
		...
		"Atemarbeit":							["exercise", "exercise_relax"],
		"Autogenes Training":					["exercise", "exercise_relax"],
		"ENTSPANNUNG":							["exercise", "exercise_relax"],
		"Feldenkrais":							["exercise", "exercise_relax"],
		"Massage":								["exercise", "exercise_relax"],
		"Muskelentspannung":					["exercise", "exercise_relax"],
		"Qi Gong":								["exercise", "exercise_relax"],
		"Tai Ji Quan":							["exercise", "exercise_relax"],
		"Yoga":									["exercise", "exercise_relax"],
		"Stimme":								["exercise", "exercise_relax"],
		"Alexandertechnik":						["exercise", "exercise_relax"],
		"Meditation":							["exercise", "exercise_relax"],
		"Achtsamkeit":							["exercise", "exercise_relax"],
		"Backen":								["exercise", "exercise_nutri_cook"],
		"ERNÄHRUNG":							["exercise", "exercise_nutri_cook"],
		"Kochen":								["exercise", "exercise_nutri_cook"],
		"Ernährungsberatung":					["exercise", "exercise_nutri_cook"],
		"Gesundheitspflege":					["exercise", "exercise_health"],
		"Krankenpflege":						["exercise", "exercise_health"],
		"Erkrankungen":							["exercise", "exercise_health"],
		"Heilmethoden":							["exercise", "exercise_health"],
		...
		"Gebärdensprache":						["intercultural", "intercultural_language_course", "intercultural_deaf"],
		"Deutsch Fremdsprache":					["intercultural", "intercultural_language_course", "intercultural_de_foreign"],
		...
		"Deutsch Leichte Sprache":				["intercultural", "intercultural_language_course", "intercultural_de_light"],
		...
		"Alphabetisierung":						["education", "education_basic"],
		...
		"Alphabetisierung":						["education", "education_basic"],
		"Lerntechniken":						["education", "education_basic"],
		"Lesen":								["education", "education_basic"],
		"Mathematik":							["education", "education_basic"],
		"Rechnen":								["education", "education_basic"],		
		"Alltagskompetenzen":					["education", "education_basic"],
		"Digitale Grundbildung":				["education", "education_basic"],	
		...
		"EDV":							["it"],
		"BERUF":						[],
		"GRUNDBILDUNG":					["education_basic"],
		"PÄDAGOGIK":					["education_edu"],
		"DDR":							["education_history"],
		"GESCHICHTE":					["education_history"],
		"LÄNDERKUNDE":					[],
		"POLITIK":						["culture", "culture_politics"],
		"NLP":							["education_psychology"],
		"PSYCHOLOGIE":					["education_psychology"],
		"UMWELT":						["culture", "culture_environment"],
		"FOTO":							["arts", "arts_misc", "arts_photo_film_media"],
		"FILM":							["arts", "arts_misc", "arts_photo_film_media"],
		"MEDIEN":						["arts", "arts_misc", "arts_photo_film_media"],
		"KUNSTHANDWERK":				["arts", "arts_crafts"],
		"SCHREIBEN":					["arts", "arts_misc", "arts_writing"],
		"LITERATUR":					["culture", "culture_literature"],
		"MALEN":						["arts", "arts_paint_craft"],
		"ZEICHNEN":						["arts", "arts_paint_craft"],
		"MUSIK":						["arts", "arts_misc"],
		"PLASTISCHES GESTALTEN":		["arts", "arts_misc", "arts_crafts"],
