			...
			.then(
				function(data){
					fs.readFile(self.options.configPath+'/template.html', {encoding: 'utf-8'}, function(error, template) {
						...
						const description = data.description && (data.description[lang] || data.description[icUtils.config.defaultLanguageCode || 'en'] || '').replace('"', "'")

						console.log(description, lang, data.description, data.description[lang], data.description && data.description[lang])
